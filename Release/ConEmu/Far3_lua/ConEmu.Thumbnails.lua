...
Macro {
  area="Shell"; key="CtrlShiftF1"; flags=""; description="ConEmu: Switch Thumbnails view on active panel"; action = function()
    Plugin.Call(ConEmuTh,1)
  end
}

Macro {
  area="Shell"; key="CtrlShiftF2"; flags=""; description="ConEmu: Switch Tiles view on active panel"; action = function()
